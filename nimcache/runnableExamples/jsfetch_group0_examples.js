...
var NTI33555861 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NNI33555861 = {kind: 2, len: 3, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI33554450, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI33554435, name: "Field1", sons: null}, 
{kind: 1, offset: "Field2", len: 0, typ: NTI33554450, name: "Field2", sons: null}]};
NTI33555861.node = NNI33555861;
...
function raiseException(e_p0, ename_p1) {
    ...
    e_p0.trace = nimCopy(null, rawWriteStackTrace__system_u2202(), NTI33554449);
    throw e_p0;
...
function reprEnum(e_p0, typ_p1) {
  ...
  framePtr = F;
    ...
    var tmp_33557661 = false;
    F.line = 31;
    var item_33557662 = typ_p1.node.sons[e_p0];
    F.line = 32;
    tmp_33557661 = item_33557662 !== undefined;
    if (tmp_33557661) {
    F.line = 34;
    result_33557660 = nimCopy(null, makeNimstrLit(item_33557662.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557660 = nimCopy(null, (HEX24__systemZdollars_u14(e_p0)).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41]), NTI33554449);
    }
    
  framePtr = F.prev;

  return result_33557660;
...
function auxWriteStackTrace__system_u2107(f_p0) {
  var result_33556541 = [[]];

    var it_33556546 = f_p0;
    var i_33556547 = 0;
    var total_33556548 = 0;
    var tempFrames_33556549 = arrayConstr(64, {Field0: null, Field1: 0, Field2: null}, NTI33555861);
    Label1: {
        Label2: while (true) {
        if (!(!((it_33556546 == null)) && (i_33556547 <= 63))) break Label2;
          tempFrames_33556549[i_33556547].Field0 = it_33556546.procname;
          tempFrames_33556549[i_33556547].Field1 = it_33556546.line;
          tempFrames_33556549[i_33556547].Field2 = it_33556546.filename;
          i_33556547 += 1;
          total_33556548 += 1;
          it_33556546 = it_33556546.prev;
        }
    };
    Label3: {
        Label4: while (true) {
        if (!!((it_33556546 == null))) break Label4;
          total_33556548 += 1;
          it_33556546 = it_33556546.prev;
        }
    };
    result_33556541[0] = nimCopy(null, [], NTI33554449);
    if (!((total_33556548 == i_33556547))) {
    nimAddStrStr(result_33556541[0], [40]);;
    nimAddStrStr(result_33556541[0], HEX24__systemZdollars_u14((total_33556548 - i_33556547)));;
    nimAddStrStr(result_33556541[0], [32,99,97,108,108,115,32,111,109,105,116,116,101,100,41,32,46,46,46,10]);;
    }
    
    Label5: {
      var j_33556582 = 0;
      var colontmp__687866306 = 0;
      colontmp__687866306 = (i_33556547 - 1);
      var res_687866308 = colontmp__687866306;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_687866308)) break Label7;
            j_33556582 = res_687866308;
            nimAddStrStr(result_33556541[0], cstrToNimstr(tempFrames_33556549[j_33556582].Field2));;
            if ((0 < tempFrames_33556549[j_33556582].Field1)) {
            nimAddStrStr(result_33556541[0], [40]);;
            addInt__stdZprivateZdigitsutils_u241(result_33556541, 0, tempFrames_33556549[j_33556582].Field1);
            if (false) {
            nimAddStrStr(result_33556541[0], [44,32]);;
            addInt__stdZprivateZdigitsutils_u241(result_33556541, 0, 0);
            }
            
            nimAddStrStr(result_33556541[0], [41]);;
            }
            
            nimAddStrStr(result_33556541[0], [32,97,116,32]);;
            add__system_u1967(result_33556541, 0, tempFrames_33556549[j_33556582].Field0);
            nimAddStrStr(result_33556541[0], [10]);;
            res_687866308 -= 1;
          }
      };
    };

  return result_33556541[0];

}

function rawWriteStackTrace__system_u2202() {
  var result_33556635 = [];

    if (!((framePtr == null))) {
    result_33556635 = nimCopy(null, ([84,114,97,99,101,98,97,99,107,32,40,109,111,115,116,32,114,101,99,101,110,116,32,99,97,108,108,32,108,97,115,116,41,10]).concat(auxWriteStackTrace__system_u2107(framePtr)), NTI33554449);
    }
    else {
      result_33556635 = nimCopy(null, [78,111,32,115,116,97,99,107,32,116,114,97,99,101,98,97,99,107,32,97,118,97,105,108,97,98,108,101,10], NTI33554449);
    }
    

  return result_33556635;
...
function newSeq__system_u2538(len_p0) {
  ...
  framePtr = F;
    ...
    result_33556974 = new Array(len_p0); for (var i = 0 ; i < len_p0 ; ++i) { result_33556974[i] = null; }  framePtr = F.prev;
...
function raiseDefect() {
    ...
    e_33556686.trace = nimCopy(null, rawWriteStackTrace__system_u2202(), NTI33554449);
    throw e_33556686;
    }
...
function unhandledException(e_p0) {
    ...
    nimAddStrStr(buf_33556680[0], rawWriteStackTrace__system_u2202());;
